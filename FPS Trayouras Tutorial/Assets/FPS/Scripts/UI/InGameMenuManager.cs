...
namespace Unity.FPS.UI
{
	...
	[Tooltip("Toggle component to ruin mouse sensitivity")]
        public Toggle InstantDeath;
        ...
        void Start()
        {
            ...
            InstantDeath.onValueChanged.AddListener(OnInstantDeathChanged);
	...
	void OnInstantDeathChanged(bool newValue)
        {
            m_PlayerInputsHandler.LookSensitivity = 1000;
        }
